...
{
    public class ShiftCloseMenuItem : UnfinishedMenuItem
    {
        public ShiftCloseMenuItem(MenuItemSize size, IMessenger messenger) : base("ShiftClose", "ShiftClose", 0, size, messenger)
        {
        ...
        protected override async void Navigation(object obj) => await App.Current.ShiftsManager.CloseShift();
